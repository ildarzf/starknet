...
Набираем легко количество активных дней
Логика. 
...
Последним этапом после прогона всех контрактов можно удалить текущюю базу данных и стартануть новые задния для тех же кошельков. Прогнали 50% в один день стопнули на следующий день оптья 50 % и стопнули. 
В итоге на части кошельков будет на 1-2 транзы больше.
Чтобы не попасть в кластера (Паранойя наше все)
